...
Note: This is the actively maintained fork of the original: https://github.com/Vincit/tarn.js
...
- Addresses timer/promises leaks, adds `settle()` method on resource

### 3.0.1 2020-10-25

- Added triggering missing createFail event on timeout error - fixes [#57](https://github.com/Vincit/tarn.js/issues/57)

### 3.0.0 2020-04-18

- Async validation support, now validation resource function can return a promise [#45](https://github.com/Vincit/tarn.js/issues/45)
- Fixed releasing abandoned resource after creation when create timeout [#48](https://github.com/Vincit/tarn.js/issues/48)
...
- Accidentally published breaking changes in 1.2.0. Unpublished it and published again with correct version number 2.0.0 [#33](https://github.com/Vincit/tarn.js/issues/33)

### 1.2.0 2019-06-02 (UNPUBLISHED)

- Passing unknown options throws an error [#19](https://github.com/Vincit/tarn.js/issues/19) [#32](https://github.com/Vincit/tarn.js/issues/32)
- Diagnostic event handlers to allow monitoring pool behaviour [#14](https://github.com/Vincit/tarn.js/issues/14) [#23](https://github.com/Vincit/tarn.js/issues/23)
- Dropped node 6 support [#25](https://github.com/Vincit/tarn.js/issues/25) [#28](https://github.com/Vincit/tarn.js/issues/28)
- pool.destroy() now always waits for all pending destroys to finish before resolving [#29](https://github.com/Vincit/tarn.js/issues/29)

### 1.1.5 2019-04-06

- Added changelog [#22](https://github.com/Vincit/tarn.js/issues/22)
- Handle opt.destroy() being a promise with destroyTimeout [#16](https://github.com/Vincit/tarn.js/issues/16)
- Explicitly silence bluebird warnings [#17](https://github.com/Vincit/tarn.js/issues/17)
- Add strict typings via TypeScript [#10](https://github.com/Vincit/tarn.js/issues/10)
